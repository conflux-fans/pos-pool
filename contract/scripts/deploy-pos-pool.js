...
async function main() {
  ...
  // await addPoolToManager(managerContract, poolAddress);
  // await setPoolName(poolContract, "TestOne");
  // await getPools(managerContract);
  // await getPoolInfo(poolContract);
  // await registerPool(poolAddress, registData);
...
async function registerPool(poolAddress, data) {
