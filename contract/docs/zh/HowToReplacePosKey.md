...
3. 待所有票解锁完成之后，获取新的 PoS 节点注册数据，并执行注册操作
4. 重新帮所有用户的票进行质押操作
...
需要等待所有票解锁完成之后，方可进行新的注册操作。可在 [Scan PoS 账户详情页 待处理票权 Tab](https://confluxscan.org/pos/accounts/0x947c684e270131a1aab8711d2e321fc0e909318d885cfe69d4fc0158aded22d0?tab=right-status) 查看此信息（需要替换自己 pos 节点的地址信息）。
